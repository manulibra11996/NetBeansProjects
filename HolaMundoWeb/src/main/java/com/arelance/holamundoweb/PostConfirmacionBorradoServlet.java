 ...
 * @author Manuel
 */
@WebServlet(name = "PostConfirmacionBorradoServlet", urlPatterns = {"/PostConfirmacionBorradoServlet"})
public class PostConfirmacionBorradoServlet extends HttpServlet {
