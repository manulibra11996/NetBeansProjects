 ...
 */
package com.arelance.holamundoweb.procesado;
 ...
 * @author Manuel
 */
@WebServlet(name = "PostDatosPersonales", urlPatterns = {"/PostDatosPersonales"})
public class PostDatosPersonales extends HttpServlet {
