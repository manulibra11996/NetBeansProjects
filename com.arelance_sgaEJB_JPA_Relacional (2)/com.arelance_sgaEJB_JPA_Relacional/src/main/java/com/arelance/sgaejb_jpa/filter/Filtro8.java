 ...
 * @author Manuel
 */
@WebFilter(filterName = "Filtro8", urlPatterns = {"/MainServlet"})
public class Filtro8 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain){
        ...
        if(nombre != null && min != null && max != null){
            ...
            MaxDTO maxEnv = new MaxDTO(Integer.parseInt(request.getParameter("max")));
            request.setAttribute("lista", personaDAO.listarFiltroPersonas(minEnv, maxEnv, nombre));
            return;
        }
