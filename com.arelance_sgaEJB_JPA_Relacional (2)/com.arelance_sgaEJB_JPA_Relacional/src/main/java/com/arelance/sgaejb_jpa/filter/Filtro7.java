 ...
 * @author Manuel
 */
@WebFilter(filterName = "Filtro7", urlPatterns = {"/MainServlet"})
public class Filtro7 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain){
        ...
        if(nombre == null && min != null && max != null){
            ...
            request.setAttribute("lista", personaDAO.listarFiltroPersonas(minEnv, maxEnv));
            return;
        }
