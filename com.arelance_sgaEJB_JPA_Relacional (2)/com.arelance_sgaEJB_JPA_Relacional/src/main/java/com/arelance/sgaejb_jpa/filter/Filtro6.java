 ...
 * @author Manuel
 */
@WebFilter(filterName = "Filtro6", urlPatterns = {"/MainServlet"})
public class Filtro6 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain){
        ...
        if(nombre != null && min != null && max == null){
            ...
            request.setAttribute("lista", personaDAO.listarFiltroPersonas(minEnv, nombre));
            return;
        }
