...
//Variables de la clase
    ...
    private static final String[][][] mensajes = {{{"Inserte el nombre del contacto que buscas: ","El contacto que buscas es " },{"Inserte el email del contacto que buscas: ","El contacto que buscas es " },{"Inserte el telefono del contacto que buscas: ","El contacto que buscas es " }},{{"Inserte el nombre del contacto que vas a modificar: ","El contacto que buscas es " },{"Inserte el email del contacto que vas a modificar: ","El contacto que buscas es " },{"Inserte el telefono del contacto que vas a modificar: ","El contacto que buscas es " }}};
    //Array bidimensional con todas las opciones
    private static final String[][] opciones = {{"Alta","Listar","Buscar","Modificar","Salir"},{"Nombre","Email","Telefono","Salir"},{"Nombre","Email","Telefono"}};
...
//        } 
    ...
    public static void buscarContacto(int busqueda, int mensaje, int opcion){
    //Variables del metodo
        ...
        System.out.println("Con que vas a buscar esta vez:");
        opciones(2);
        ...
        switch(metodo){
            case 1:
                ...
                System.out.println(mensajes[busqueda][mensaje][opcion]);
                ...
                for (int i = 0; i < contactos.length; i++) {
                    ...
                    if(nombre.equals(contactos[i][0])){
                        ...
                        System.out.print(mensajes[busqueda][mensaje][++opcion]);
            ...
            case 2:
                ...
                //variables recibo cuando llamo al metodo
                System.out.println(mensajes[busqueda][++mensaje][opcion]);
                //Añade a la variable el email que introducimos por teclado
                email = teclado.next();
                //Bucle que carga todos los contactos del array
                for (int i = 0; i < contactos.length; i++) {
                    //Busca una coincidencia entre el valor de email y los valores 
                    //que contiene el array en la posicion 0
                    if(email.equals(contactos[i][1])){
                        //Variable que guarda el numero del indice donde se encuentra el 
                        //contacto que queremos modificar
                        buscado=i;
                        //Inserta una cadena de texto vacia
                ...
                //Si no se encuentra ningun contacto con el email pasado carga este codigo
                if(!encontrado){
                    //Inserta una cadena de texto vacia
                    System.out.println(" ");
                    //Muestra un mensaje con el nombre pasado por teclado
                    System.out.println("No existe ningun contacto con el email " + email);
                    //Indica que el contacto no es modificable
                    mod = false;
                }
                break;
            case 3:
                //Muesta el mensaje que se guarda en un array bidimensional, cuyas 
                //variables recibo cuando llamo al metodo
                System.out.println(mensajes[busqueda][2+mensaje][opcion]);
                //Añade a la variable el telefono que introducimos por teclado
                telefono = teclado.next();
                //Bucle que carga todos los contactos del array
                for (int i = 0; i < contactos.length; i++) {
                    //Busca una coincidencia entre el valor de telefono y los valores 
                    //que contiene el array en la posicion 0
                    if(telefono.equals(contactos[i][2])){
                        //Variable que guarda el numero del indice donde se encuentra el 
                        //contacto que queremos modificar
                        buscado=i;
                        //Inserta una cadena de texto vacia
                        System.out.println(" ");
                        //Muesta el mensaje que se guarda en un array bidimensional
                        System.out.print(mensajes[busqueda][2+mensaje][opcion++]);
                        //Muestra los datos del contacto que buscamos
                        System.out.print(contactos[i][0] + ", su email es " + contactos[i][1] + " y su telefono es " + contactos[i][2]);
                        //Indica que el contacto a sido encontrado
                        encontrado = true;
                ...
                //Si no se encuentra ningun contacto con el telefono pasado carga este codigo
                if(!encontrado){
                    //Inserta una cadena de texto vacia
                    System.out.println(" ");
                    //Muestra un mensaje con el nombre pasado por teclado
                    System.out.println("No existe ningun contacto con el telefono " + telefono);
                    //Indica que el contacto no es modificable
                    mod = false;
                }
                break;
