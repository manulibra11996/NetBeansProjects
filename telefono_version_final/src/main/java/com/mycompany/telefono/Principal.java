...
//Variables de la clase
    ...
    //Variables del metodo
        ...
        for (String opcion : numOpciones) {
            ...
            System.out.printf("Opcion %s: %s", numOpcion, opcion);
...
//        }
    ...
    //Variables del metodo
        ...
        for (int i = 0; i < recibidos.length; i++) {
            ...
            System.out.printf("Indique el %s: ", datos[i]);
    ...
    public static void mensaje(boolean correcto){
        switch(mensaje){
            ...
            case 2:
                if(correcto){
                    System.out.printf("El contacto es %s, su email es %s y su telefono es %s" , contactos[buscado][0] ,
                            contactos[buscado][1] ,contactos[buscado][2]);
                }else{
            ...
            case 3:
                if(correcto){
                    System.out.printf("El contacto %s ha sido modificado", contactos[buscado][0]);
                }
            break;
        }
    }
...
//        } 
    ...
    public static String modificador(int buscado,int opcion){
        switch(opcion){
                    case 1:
                        System.out.printf("El contacto cuyo nombre es %s se va a cambiar por ", contactos[buscado][0]);
                        return teclado.next();
                    case 2:
                        System.out.printf("El contacto cuyo email se %s se va a cambiar por ", contactos[buscado][1]);
                        return teclado.next();
                    case 3:
                        System.out.printf("El contacto cuyo telefono es %s se va a cambiar por ", contactos[buscado][2]);
                       return teclado.next();
                }
        return "Salida";
    }
