 ...
 */
package com.arelance.sgaejb_jpa.controler;
 ...
 * @author Manuel
 */
@WebServlet(name = "PreBusquedaEmail", urlPatterns = {"/PreBusquedaEmail"})
public class PreBusquedaEmail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("usuarioEmail.jsp").forward(request, response);
        }
    }
